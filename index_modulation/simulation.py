...
class Simulation():
    ...
    """
    def __init__(self,plot=False, num_of_tx=8, num_of_rx=1, r_rx=5, r_tx=0.5, D=79.4,step=0.0001, time=0.75, d_yz=10, d_x=10, center_of_rx = np.array([0,0,0]), mol_number=10000):
    ...
    def start_simulation(self):
        ...
        for i in range(int(self.time / self.step)):
            ...
            print("step: " + str(i) + "/" + str(int(self.time / self.step)) + " is done!")
            pos = pos2
